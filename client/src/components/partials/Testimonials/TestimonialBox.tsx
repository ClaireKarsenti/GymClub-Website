...
function TestimonialBox({
  ...
  return (
    <div
      className={`absolute flex flex-col bg-black  top-0 right-0 w-[60%] md1000:w-full h-full py-[47px] px-[50px] min540:py-[24px] min540:px-[30px] min540:h-[50rem] min375:h-[80rem] ${
        isActive ? '' : 'hidden'
      }`}
    >
